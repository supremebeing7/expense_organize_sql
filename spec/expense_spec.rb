...
describe Expense do
	it 'initializes with a description, amount, category_id, and company_id' do
		test_expense = Expense.new({'description' => 'burger', 'amount' => 9.50, 'company_id' => 5, 'date' => '2014-09-09'})
	...
	it 'gives us the description, amount, category_id, and company_id' do
		...
		test_expense.date.should eq '2014-09-09'
	end
	...
	describe '#==' do
		it 'is equal if description, amount, category_id, and company_id are the same' do
			test_expense1 = Expense.new({'description' => 'burger', 'amount' => 9.50, 'company_id' => 5, 'date' => '2014-09-09'})
			test_expense2 = Expense.new({'description' => 'burger', 'amount' => 9.50, 'company_id' => 5, 'date' => '2014-09-09'})
	...
	describe '.create' do
		it 'creates and saves an expense to the database' do
			...
			test_expense3 = Expense.create({'description' => 'taco', 'amount' => 2.99, 'company_id' => 4, 'date' => '2014-08-07'})
